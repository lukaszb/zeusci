...
from zeusci.zeus.utils.general import lookup_value
import warnings
...
class HyperlinkedIdentityField(Field):
    ...
    def __init__(self, *args, **kwargs):
        ...
        lookup_field = kwargs.pop('lookup_field', None) or self.lookup_field
        if isinstance(lookup_field, six.string_types):
            lookup_field = {lookup_field: lookup_field}
        # lookup_field should be a dict
    ...
    def get_url(self, obj, view_name, request, format):
        ...
        kwargs = {url_attr: lookup_value(obj, model_attr) for url_attr, model_attr in self.lookup_field.items()}
        try:
